...
INSERT INTO `pregunta` VALUES (294,'Cuando, para relacionar dos tablas dadas, se crea una tercera tabla\nque contiene las PK de las primeras, ¿qué tipo de relación entre\ntablas implementamos?','n:n','',1,1,113),(311,'Codifica en binario, en 8 bits, el número negativo -51','11001101','',1,1,118),(356,'¿Cuál es el cometido del compilador de C?\\TH{6}','El compilador traduce el código C (código fuente) en una versión ejecutable por la CPU (código máquina). Durante la traducción detecta posibles errores de sintaxis','',1,1,109),(368,'¿Cuáles son las cuatro etapas en el ciclo de vida de una base de datos?\n(aplicables también a otros desarrollos de software)\\TH{4}','Análisis, Diseño, Implementación y Pruebas y mantenimiento.','',1,1,115),(369,'Pon un par de ejemplos de datos cartográficos que suelan almacenarse en\n formato vectorial en las bases de datos geográficas.\\TH{5}','Trazado de carreteras, cursos de ríos, contornos de lagos, de regiones o países.','',1,1,116),(370,'Define qué es una instancia de una base de datos e indica si cambia a menudo o no.\\TH{6}','Es la información que contiene una BD en un instante dado. Cambia continuamente, debido a las altas, bajas y modificaciones','',1,1,112),(385,'Describe brevemente qué misión tiene el registro ·PC· dentro una CPU.\\TH{7}','El registro PC (\\emph{Program Counter}) contiene la dirección de\n memoria a la que se irá a buscar la próxima instrucción a ejecutar.','',1,1,121),(402,'\\def\\dato{49} Convierte el número \\dato (decimal) a su representación binaria con 8 bits y  a hexadecimal','Binario: 110001\nHex: 31h','',1,1,117),(403,'Un disco duro pone en su caja que su capacidad es de  512\\,GB. \nEl comprador, que desconoce el estándar internacional de unidades,\ncree equivocadamente que GB son lo mismo que GiB. En realidad el disco\n¿tiene más o menos bytes de lo que él cree? ¿cuántos más o menos? Puedes\ndejar indicada la operación en la respuesta, pero las unidades (bytes)\nhan de estar correctas. Recuerda que $1024=2^{10}$. \\TH{5}','Tiene menos: $512\\times(2^{30}-10^{9})$ = $512\\times{73\\,741\\,824}$ =\n{37\\,755\\,813\\,888} (unos 35\\,GiB).','',1,1,119),(404,'Une con líneas los siguientes ejemplos de Sistema Operativo con su tipo\n(nota: pueden quedar puntos sin unir, o varias líneas ir al mismo punto).\n\n\\begin{respuestaespecial}\\centerline{\n      \\begin{tikzpicture}[x=0.7cm]\n        \\tikzset{punto/.style={below=5mm of anterior, fill=black, inner sep=.5mm, circle},\n                 raya/.style={color=solucion, decorate, decoration=bent}}\n        % Columna de sistemas operativos\n        \\coordinate (anterior) at (0,0);\n        \\foreach \\p in {\n           Linux,\n           Android,\n           MS-DOS,\n           Windows {3.1}}{\n             \\node[punto,label=left:\\p] (\\p) {}; \\coordinate (anterior) at (\\p);\n          }\n        % Columna de tipos de SO\n        \\coordinate (anterior) at (2,.2);\n        \\foreach \\p in {\n           Monousuario y monotarea,\n           Monousuario y multitarea,\n           Multiusuario y monotarea,\n           Multiusuario y multitarea,\n           Empotrado}{\n             \\node[punto,label=right:\\p] (\\p) {}; \\coordinate (anterior) at (\\p);\n          }\n        % Solución (unir los puntos)\n        \\draw[raya]\n           (Linux)         -- (Multiusuario y multitarea)\n           (Android)       -- (Empotrado)\n           (Android)       -- (Monousuario y multitarea)\n           (MS-DOS)        -- (Monousuario y monotarea)\n           (Windows {3.1}) -- (Monousuario y multitarea)\n          ;\n       \\end{tikzpicture}\n  }\n  \\end{respuestaespecial}','','',1,1,122),(413,'Observa el siguiente código y escribe en el recuadro inferior qué saldrá por pantalla\n\n\\begin{listadoC}\na=4;  b=4;  c=5;\nif (a==b)\n  if (b<c)\n      cout << \"Uno\" << endl;\n  else\n      cout << \"Dos\" << endl;\ncout << \"Tres\" << endl;\n\\end{listadoC}\n\\TH{3}','Uno\\\\\nTres','',1,1,125),(415,'Se tienen dos tablas, que llamaremos A y B. Se quiere implementar una\nrelación 1:n de modo que a 1 registro de la tabla A se puedan asociar\nmuchos registros de la tabla B, pero a cada registro de la tabla B sólo\nse puede asociar uno de la A. ¿Cómo lo haríamos? Indica si debemos crear\notra tabla, o si hay que añadir un campo a alguna de las existentes (y a\ncuál) y qué contendría la tabla o campo añadido.\n\\TH{7}','Habría que añadir un campo a la tabla B, conteniendo la PK del elemento\nde la A con el que se relaciona cada elemento de B.','',1,1,126),(422,'Cuando ejecutemos el programa ¿cuántas líneas aparecerán en pantalla?','35 líneas (5 iteraciones de ·i· por 7 de ·j·)','',1,1,105),(423,'¿Cuántas veces aparecerá el número cero en la salida del programa?','11 veces','En la primera iteración del bucle externo, la ·i· vale 0 por lo que independientemente \nde ·j· el resultado será cero, luego salen 7 ceros en esta primera iteración del bucle \nexterior. En cada una de las cuatro restantes iteraciones del bucle exterior,  aparecerá\n·0· cuando ·j· es cero, lo que ocurre una sola vez por cada iteración exterior, lo cual \nnos da cuatro ceros más.',1,2,105),(424,'El código anterior contiene un error. Señala en qué línea aparece, y describe en qué consiste, y qué modificación deberías hacer (y en qué líneas) para arreglarlo.\\TH{4}','Linea 8, se usa una variable ·j· sin haberla declarado.\nModificaría la línea 5 para dejarla así: ·int i,j;·','',1,1,110),(425,'Una vez resuelto el error, se compila y se ejecuta el código\n¿cuántas líneas imprimirá el programa antes de terminar?','100 líneas (10 iteraciones de i por 10 de j)','',1,2,110),(426,'¿Y cuántas veces aparecerá el número 15 en la salida del programa?','4 veces.','',1,3,110),(427,'¿Qué falta en el hueco de la línea~\\ref{leer:array:inicializacion}?','·contador=0·','',1,1,111),(428,'¿Qué debería ir en la línea~\\ref{leer:array:if:nota10}?','·if (nota > 10.0)·','',1,2,111),(429,'Completa la asignación del array en la línea~\\ref{leer:array:asignar:notas}','·notas[contador]=nota;·','',1,3,111),(430,'¿Qué debería ir en la línea~\\ref{leer:array:incrementar:contador}?','·contador=contador+1;· o ·contador++;·','',1,4,111),(431,'Completa la condición del bucle ·do while·, en la línea~\\ref{leer:array:condicion:while}','·while (nota>0 && contador < 1000);·','',1,5,111),(432,'Completa el ·return· de la línea~\\ref{leer:array:return:contador}','·return contador;·','',1,6,111),(433,'A continuación se muestra un caso en el que se llama a la función anterior\ndesde otra (en este caso desde la función ·main()·). De nuevo el código\ncontiene huecos tapados para que respondas más adelante.\n\n\\begin{listadoC}\nint main()\n{\n  int i;\n  float n[1000];\n  int cuantas;\n\n  ·falta«cuantas   » = pide_notas(·falta«  n »);·label«leer:array:llamada»\n  // Imprimir las notas que se han leido\n  for (i=0; i<cuantas; i++)\n    cout << \"Nota \" << i+1 << \"=\" << n[i] << endl;\n\n  // Calcular la nota media\n  cout << \"La nota media del curso es \";\n  cout << nota_media(n, cuantas) << endl;\n}\n\\end{listadoC}\n\n  Completa la línea~\\ref{leer:array:llamada}','·cuantas = pide_notas( n );·','',1,7,111),(434,'Escribe el código de la función ·nota_media· que es llamada en la última\nlínea de ·main()·. Debes escribir la función completa, con su cabecera,\nparámetros, variables locales (si las requiere) y algoritmo que calcule\nel promedio de las notas recibidas. La función retorna (en un ·float·)\nel promedio calculado. Puedes asumir que el segundo parámetro es siempre\nmayor de cero, para simplificar el código.\\TH{15}','\\begin{Verbatim}[fontsize=\\small]\nfloat nota_media(float n[], int c)\n{\n   float suma=0.0;\n   int i;\n   for (i=0; i<c; i++)\n     suma+=n[i];\n   return (suma/c);\n}\n\\end{Verbatim}','',2,8,111),(435,'Inventa un ejemplo para una tabla adicional que tenga una relación 1:1\ncon la tabla de estrellas.     \\TH{5}','Una tabla que almacene datos adicionales sobre cada estrella, como\npor ejemplo su color, distancia a la que se encuentra, tamaño, tipo\nde estrella, etc.','',1,1,114),(436,'Escribe qué campos tendría la tabla ·Estrellas·, usando la notación\nempleada en clase para marcar las claves propias (·@·) y\nlas ajenas (subrayado).     \\TH{9}','\\begin{Verbatim}[fontsize=\\small,commandchars=\\·\\«\\»]\n-@Nombre\n-Magnitud\n-Ascension_recta\n-Declinación\n-·ul«Constelación»\n\\end{Verbatim}','',1,2,114),(437,'Escribe qué campos tendría la tabla ·Constelaciones·, usando la notación\nempleada en clase para marcar las claves propias (·@·) y\nlas ajenas (subrayado). \\TH{7}','\\begin{Verbatim}[fontsize=\\small,commandchars=\\·\\«\\»]\n-@Nombre\n\\end{Verbatim}','',1,3,114),(438,'Como ayuda a las cuestiones siguientes, se proporciona seguidamente un\nbreve recordatorio de la sintaxis de algunas consultas~SQL.\n\n\\begin{Verbatim}[fontsize=\\small,frame=single,commandchars=\\·\\«\\»]\n·textnormal«Consulta simple:»\nSELECT ·emph«campos» FROM ·emph«tabla» WHERE ·emph«condición»;\n\n·textnormal«Agrupación y totales:»\nSELECT ·emph«campos», funcion(·emph«campo») FROM ·emph«tabla»\n       WHERE ·emph«condición» GROUP BY ·emph«campo»;\n       ·textnormal«Funciones:» COUNT(), SUM(), AVG(), ...\n\n·textnormal«Composición de tablas:»\nSELECT ·emph«campos» FROM ·emph«tabla1» INNER JOIN ·emph«tabla2»\n    ON ·emph«tabla1.clave_ajena»=·emph«tabla2.clave_propia»;\n\\end{Verbatim}\n\nEscribe la consulta SQL que muestre las estrellas de magnitud menor de\n2 (que son visibles a simple vista).    \\TH{3}','\\begin{Verbatim}[fontsize=\\small]\nSELECT Nombre FROM Estrellas\n       WHERE Magnitud<2.0;\n\\end{Verbatim}','',1,4,114),(445,'¿Cuáles son los nombres de los dos bloques que aparecen sin etiquetar?','Memoria y CPU','',1,1,120),(446,'¿Cuáles son los nombres de los dos buses que aparecen sin etiquetar?','Bus de direcciones y bus de datos.','',1,2,120),(454,'El código anterior no es eficiente porque incluso si ya ha detectado que\nes primo, sigue probando con todos los enteros siguientes, y esto ya no\nsería necesario. Reescribe el código para que sea más eficiente.\n\\TH{18}','\\begin{Verbatim}[fontsize=\\small]\n{\n// no necesitamos declarar la esprimo\nint divisor;\ndivisor=2;\nwhile (divisor<dato) {\n  if (dato%divisor==0)\n     return false;\n  divisor++;\n}\n// Si llegamos aqui sin haber encontrado\n// divisores es que era primo\nreturn true;\n}\n\\end{Verbatim}','',1,3,123),(455,'¿Qué falta en el hueco de la línea~\\ref{c.primos.001.1}?','·contador++;· o ·contador=contador+1;·','',1,6,123),(456,'Si dicha función se llama ·EsPrimo·, y el parámetro que recibe se llama\n·dato·, escribe la cabecera de dicha función.','·bool EsPrimo(int dato)·','',1,1,123),(457,'A continuación se muestra el programa principal (·main·) que,\nhaciendo uso de la función anterior, debe imprimir los 10 primeros\nnúmeros primos mayores de 1000. El programa contiene partes tapadas sobre\nlas que se harán preguntas. El tamaño de la zona tapada no guarda\nrelación con la longitud de la respuesta.\n\n\\begin{listadoC}\n#include<iostream>\nusing namespace std;\n\n// Omitido el código de la funcion EsPrimo\n// que vendría aquí\n\nint main(void)\n{\n  int n=1000;\n  int contador=0;\n  bool esprimo;\n\n  while(·falta«contador<10               ») {\n    esprimo=·falta«EsPrimo(n)     »;\n    if (esprimo) {\n      cout << n << endl;\n      ·falta«contador++;        »·label«c.primos.001.1»\n    }\n    n=n+1;\n  }\n  return 0;\n}\n\\end{listadoC}\n\n¿Qué falta en el hueco de la condición del ·while·?','·(contador < 10)·','',1,4,123),(458,'¿Qué falta en el hueco donde se asigna un valor a la variable ·esprimo·?','·esprimo=EsPrimo(n)·','',1,5,123),(459,'Lo que sigue sería el código preliminar de dicha función (se ha omitido la cabecera,\nque sería la que has puesto en la respuesta anterior). Este código, tal\ncomo está, no funcionará correctamente.\n\n\\begin{listadoC}\n// cabecera omitida\n{\n  bool esprimo=true;     // Supongamos que es primo\n  int divisor;\n  while (divisor<dato) {\n    if (dato%divisor==0) // si el resto es cero...\n       esprimo=false;    // ...no es primo\n    divisor++;           // probar otro\n  }\n  return esprimo;       // retornar resultado\n }\n\\end{listadoC}\n\nEl código anterior no funciona correctamente porque la variable ·divisor·\nno ha sido inicializada con ningún valor. ¿Qué tendrías que añadir antes\ndel bucle ·while· para inicializarla correctamente?','·divisor=2;·','Hay que ir probando con diferentes divisores, comenzando con ·2·.\nComenzar con ·0· sería un error, ya que se intentaría una división por\ncero. También sería un error comenzar con ·1·, ya que todos los enteros\nson divisibles por ·1·, sean primos o no.',1,2,123),(460,'¿Qué falta en el hueco de la línea~\\ref{c.primos.001.1}?','·contador++;· o ·contador=contador+1;·','',1,6,123),(461,'El código anterior no es eficiente porque incluso si ya ha detectado que\nes primo, sigue probando con todos los enteros siguientes, y esto ya no\nsería necesario. Reescribe el código para que sea más eficiente.\n\\TH{18}','\\begin{Verbatim}[fontsize=\\small]\n{\n// no necesitamos declarar la esprimo\nint divisor;\ndivisor=2;\nwhile (divisor<dato) {\n  if (dato%divisor==0)\n     return false;\n  divisor++;\n}\n// Si llegamos aqui sin haber encontrado\n// divisores es que era primo\nreturn true;\n}\n\\end{Verbatim}','',1,3,123),(462,'A continuación se muestra el programa principal (·main·) que,\nhaciendo uso de la función anterior, debe imprimir los 10 primeros\nnúmeros primos mayores de 1000. El programa contiene partes tapadas sobre\nlas que se harán preguntas. El tamaño de la zona tapada no guarda\nrelación con la longitud de la respuesta.\n\n\\begin{listadoC}\n#include<iostream>\nusing namespace std;\n\n// Omitido el código de la funcion EsPrimo\n// que vendría aquí\n\nint main(void)\n{\n  int n=1000;\n  int contador=0;\n  bool esprimo;\n\n  while(·falta«contador<10               ») {\n    esprimo=·falta«EsPrimo(n)     »;\n    if (esprimo) {\n      cout << n << endl;\n      ·falta«contador++;        »·label«c.primos.001.1»\n    }\n    n=n+1;\n  }\n  return 0;\n}\n\\end{listadoC}\n\n¿Qué falta en el hueco de la condición del ·while·?','·(contador < 10)·','',1,4,123),(463,'¿Qué falta en el hueco donde se asigna un valor a la variable ·esprimo·?','·esprimo=EsPrimo(n)·','',1,5,123),(464,'¿Qué falta en el hueco de la línea~\\ref{c.primos.001.1}?','·contador++;· o ·contador=contador+1;·','',1,6,123),(465,'¿Qué falta en los dos huecos del listado anterior?  \\TH{4}','·indice_maximo·\\\\\n·datos[indice_maximo]·\\\\','',1,1,124),(466,'Escribe cómo sería el código completo de la función ·BuscarIndiceMaximo· que es\nllamada desde el programa anterior. \\TH{24}','\\begin{Verbatim}[fontsize=\\small]\nint BuscarIndiceMaximo(int datos[], int cuantos)\n{\n  int imax, max=datos[0];\n  int i;\n  for (i=0; i<cuantos; i++)\n    if (datos[i]>max) {\n       max=datos[i];\n       imax=i;\n    }\n  return imax;\n}\n\\end{Verbatim}','',3,2,124),(467,'Escribe qué campos tendría la tabla ·Usuarios·, con la notación\nempleada en clase para marcar las claves propias (·@·) y\nlas ajenas (subrayado).    \\TH{9}','\\begin{Verbatim}[fontsize=\\small,commandchars=\\·\\«\\»]\n-@Nick\n-Nombre\n-Contraseña\n-email\n\\end{Verbatim}','',1,1,127),(468,'Escribe qué campos tendría la tabla ·Preguntas·, usando la notación\nempleada en clase para marcar las claves propias (·@·) y\nlas ajenas (subrayado).    \\TH{7}','\\begin{Verbatim}[fontsize=\\small,commandchars=\\·\\«\\»]\n-@IDpregunta\n-Titulo\n-Contenido\n-·ul«Nick» (del autor)\n\\end{Verbatim}','',1,2,127),(469,'Escribe qué campos tendría la tabla ·Respuestas·, usando la notación\nempleada en clase para marcar las claves propias (·@·) y\nlas ajenas (subrayado).    \\TH{7}','\\begin{Verbatim}[fontsize=\\small,commandchars=\\·\\«\\»]\n-@IDrespuesta\n-Contenido\n-·ul«Nick» (del autor)\n-·ul«IDpregunta»\n\\end{Verbatim}','',1,3,127),(470,'¿Crees que serían necesarias más tablas de las indicadas en las\npreguntas anteriores para completar las relaciones en la base de datos?\nJustifica tu respuesta.    \\TH{5}','No son necesarias más tablas, puesto que no hay relaciones $n:n$.','',1,4,127);
...
-- Dump completed on 2014-06-28 20:22:17
